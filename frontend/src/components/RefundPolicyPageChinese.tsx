    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <section className="legal-section">
          ...
          <h3>2.1 已使用的额度</h3>
          <p>
            <strong>所有已使用的额度均不可退款。</strong>一旦使用额度生成了文献综述，
            该额度将无法退款。这是因为：
          </p>
          <ul>
          ...
          <h3>2.3 套餐额度</h3>
          <p>
            购买的额度套餐（单次、学期、学年）一旦使用了该套餐中的任何额度，
            即不可退款。套餐中未使用的额度不能退款，
            但可以在到期日前使用。
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <ul>
            <li><strong>单次综述：</strong>额度不过期，但仅限一次性使用</li>
            <li><strong>学期套餐：</strong>额度自购买之日起 6 个月过期</li>
            <li><strong>学年套餐：</strong>额度自购买之日起 12 个月过期</li>
          </ul>

          <h3>5.2 过期额度</h3>
          <p>
            <strong>过期额度不能退款或延期。</strong>请相应地规划您的使用，
            并在选择套餐时考虑过期日期。
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <h3>9.1 促销额度</h3>
          <p>
            通过促销、推荐或特别优惠提供的免费额度没有现金价值，
            不能退款或兑换现金。
          </p>

          <h3>9.2 注册额度</h3>
          <p>
            注册时提供的 1 个免费额度供新用户试用服务。即使未使用，
            也不能退款或兑换。
          </p>
        </section>
