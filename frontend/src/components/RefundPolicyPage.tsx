    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <section className="legal-section">
          <h2>1. Overview</h2>
          <p>
            At AutoOverview, we strive to provide a high-quality AI-powered literature review service.
          ...
          <p className="policy-highlight">
            <strong>Important:</strong> AutoOverview is a low-frequency, essential academic SaaS service.
            Due to the nature of AI-generated content and immediate service delivery, refunds are handled
        ...
        <section className="legal-section">
          ...
          <p>
            <strong>All used credits are non-refundable.</strong> Once a literature review has been generated
          ...
          <p>
            Once a literature review has been generated and delivered to your account, the transaction is
            considered complete. Due to the nature of digital content and intellectual property considerations,
            we cannot offer refunds for completed reviews.
          </p>
        ...
        <section className="legal-section">
          ...
          <ul>
            <li>The service failed to generate a review due to a technical issue on our end</li>
            <li>The review was generated but contains critical formatting errors preventing export</li>
        ...
        <section className="legal-section">
          ...
          <ul>
            <li>Dissatisfaction with the quality or content of a generated review</li>
            <li>Reviews that do not meet specific expectations or requirements</li>
          ...
          <ul>
            <li>Paper rejections related to content generated by our service</li>
        ...
        <section className="legal-section">
          ...
          <p>
            AutoOverview is designed as a low-frequency but essential service for academic work. Unlike
          ...
          <p>
            Our AI service provides high-quality literature reviews that serve as excellent research starting
            points. However, all AI-generated content should be verified and supplemented with your own
