...
class EmailTemplateConfig:
    ...
    def __init__(self):
        # 从环境变量读取配置
        self.app_name = os.getenv("AUTH_EMAIL_APP_NAME", "应用")
        ...
        self.primary_color = os.getenv("AUTH_EMAIL_PRIMARY_COLOR", "#667eea")
        self.secondary_color = os.getenv("AUTH_EMAIL_SECONDARY_COLOR", "#764ba2")
...
<head>
    ...
    <style>
        ...
        .header { background: {{ gradient }}; color: white; padding: 40px 30px; text-align: center; border-radius: 12px 12px 0 0; }
        ...
        .code { font-size: 36px; font-weight: 700; color: {{ primary_color }}; letter-spacing: 8px; font-family: 'Courier New', monospace; }
...
<head>
    ...
    <style>
        ...
        .cta-button { display: inline-block; padding: 15px 40px; background: {{ gradient }}; color: white; text-decoration: none; border-radius: 8px; font-weight: 600; margin: 20px 0; }
        .footer { text-align: center; margin-top: 30px; color: #999; font-size: 12px; }
        .footer a { color: {{ primary_color }}; text-decoration: none; }
    </style>
</head>
